        ...
        <nav class="topnavbar navbar-default topnav">
                <div class="container">
                        <div class="navbar-header">
                                ...
                                <a class="navbar-brand logo" href="#"><img src="image/logo1.png" width="150px" alt="logo"></a>
				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTC5re1slp2prWwSdIBLfYDfE1zQOeDHSc3oA&usqp=CAU" style="position: absolute; right: 6%;" width="60px" onclick="javascript:window.location=`//${window.location.hostname}:5555/account.php`;">
			</div>   
                </div>
