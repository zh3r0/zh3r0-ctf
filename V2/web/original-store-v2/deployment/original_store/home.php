...
<div class="allcontain">
        ...
        <nav class="topnavbar navbar-default topnav">
				...
				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTC5re1slp2prWwSdIBLfYDfE1zQOeDHSc3oA&usqp=CAU" style="position: absolute; right: 6%;" width="60px" onclick="javascript:window.location=`//${window.location.hostname}:6996/account.php`;">
			</div>   
                </div>
